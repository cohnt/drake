...
//       (Eigen::VectorXd(8) << 2.70112065, -1.20758987, -2.03150803, -1.07804311,
//        -2.48819643, -1.08685141, -1.53579736, -1.38)
//           .finished(),
//       (Eigen::VectorXd(8) << 2.63965699, -1.18749325, -2.0132597, -1.21658289,
//        -2.4625921, -1.02939329, -1.59729221, -1.38)
//           .finished(),
//       (Eigen::VectorXd(8) << 2.25906769, -0.86219036, -1.60831722, -1.65537528,
//        -2.36188887, -0.84644494, -1.42171464, -1.04)
//           .finished(),
//       (Eigen::VectorXd(8) << 2.28185365, -0.72782475, -1.50313087, -1.37274716,
//        -2.45070019, -0.95676235, -1.0742753, -1.11)
//           .finished(),
//       (Eigen::VectorXd(8) << 2.48360385, -1.38612501, -2.18824836, -1.75145406,
//        -2.29663347, -0.82544529, -2.24896603, -1.38)
//           .finished(),
//       (Eigen::VectorXd(8) << 2.72861773, -1.63614893, -2.24210693, -1.09417266,
//        -2.47138911, -1.08448094, -2.02794058, -1.38)
//           .finished(),
//       (Eigen::VectorXd(8) << 2.32486191, -1.02291998, -1.81556623, -1.8047083,
//        -2.2953165, -0.79500976, -1.77811966, -1.38)
//           .finished(),
//       (Eigen::VectorXd(8) << 2.25906769, -0.86219036, -1.60831722, -1.65537528,
//        -2.36188887, -0.84644494, -1.42171464, -0.84)
//           .finished(),
//       (Eigen::VectorXd(8) << 2.25906769, -0.86219036, -1.60831722, -1.65537528,
//        -2.36188887, -0.84644494, -1.42171464, -1.11)
//           .finished(),
//       (Eigen::VectorXd(8) << 2.59365015, -1.57467968, -2.27697689, -1.4690189,
//        -2.38492179, -0.93480747, -2.24248898, -1.38)
//           .finished(),
//       (Eigen::VectorXd(8) << 2.60088781, -1.16843534, -1.99676488, -1.29919554,
//        -2.44538073, -0.99542359, -1.62674558, -1.38)
//           .finished(),
//       (Eigen::VectorXd(8) << 2.50989197, -1.12647627, -1.95433979, -1.48845989,
//        -2.39881695, -0.9188784, -1.6990243, -1.38)
//           .finished(),
//       (Eigen::VectorXd(8) << 2.65520689, -1.60057213, -2.2588163, -1.29454471,
//        -2.43023076, -1.00330242, -2.13409883, -1.38)
//           .finished(),
//       (Eigen::VectorXd(8) << 2.58289571, -0.80277034, -1.76572266, -1.01905019,
//        -2.51284622, -1.10712836, -1.03205098, -1.11)
//           .finished(),
//       (Eigen::VectorXd(8) << 2.25906769, -0.86219036, -1.60831722, -1.65537528,
//        -2.36188887, -0.84644494, -1.42171464, -1.38)
//           .finished(),
//       (Eigen::VectorXd(8) << 2.27427467, -0.91169757, -1.66963928, -1.71980847,
//        -2.33578738, -0.82313381, -1.54144948, -1.38)
//           .finished(),
//       (Eigen::VectorXd(8) << 2.4406165, -1.27344528, -2.09406413, -1.80468998,
//        -2.28076815, -0.80305455, -2.14391045, -1.38)
//           .finished(),
//       (Eigen::VectorXd(8) << 2.42140818, -1.22738814, -2.05015614, -1.81848387,
//        -2.27744254, -0.79669655, -2.09164969, -1.38)
//           .finished(),
//       (Eigen::VectorXd(8) << 2.74726035, -0.8637625, -1.89093302, -0.78100625,
//        -2.54191325, -1.20940114, -0.99160079, -1.11)
//           .finished()};
...
//     }
//     frac_in_collision.push_back(1.0 -
//                                 (static_cast<double>(n_good) /
//                                  static_cast<double>(n_samples_for_collision)));

//     std::cout << "Seed " << fmt::format("{}", fmt_eigen(seed.transpose()))
//               << std::endl;
...
//     std::cout << "Seed " << fmt::format("{}", fmt_eigen(seeds[i].transpose()))
//               << std::endl;
...
TEST_F(BimanualIiwaParameterization, RegionTest) {
  ...
  for (int attempts = 0; attempts < kMaxTries; ++attempts) {
    ...
    std::cout << "Region has " << region.b().size() << " faces. (" << region.ReduceInequalities().b().size() << " nonredundant faces.)" << std::endl;
